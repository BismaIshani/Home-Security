...
% Last Modified by GUIDE v2.5 12-Jun-2013 05:21:34
...
global Im2
%imaqreset;
vid=videoinput('winvideo',1,'MJPG_1280x720');% take video input
...
try
    ...
    f=length(f);
    f=f+1;
    fname=strcat( num2str(className),'.png');
...
OutputName = Recognition(Im2, m, A, Eigenfaces);
str=OutputName;
imR=imread(str);
axes(handles.axes3);
imshow(imR);
